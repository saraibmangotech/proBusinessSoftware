...
function VccDepositedPreview() {
  ...
  const [vccDepositedDetail, setVccDepositedDetail] = useState();
  ...
  const getVccDepositedDetail = async () => {
    ...
    try {
      let params = {
        vcc_id: atob(id).split('-')[1]
      }
      const { data } = await VccServices.getVccDepositedPreview(params)
      setVccDepositedDetail(data?.details)
    } catch (error) {
      ErrorToaster(error)
    } finally {
      setLoader(false)
  ...
  return (
    <Container>
      ...
      <PDFExport ref={contentRef} fileName="VCC Deposited" >
        <Box
          sx={{
            width: "1000px",
            mx: 4,
                ...
                <Grid item xs={5.5}>
                  <Box sx={{ ml: 4, mb: 7.5 }}>
                    <Grid container spacing={0.5}>
                      ...
                      <Grid item xs={6}>
                        <Typography variant="body1" className={classes.text}>
                          {vccDepositedDetail?.booking?.customer?.name ?? "-"}
                        </Typography>
                      </Grid>
                      <Grid item xs={5}>
                        <Typography variant="body1" className={classes.text}>
                      ...
                      <Grid item xs={6}>
                        <Typography
                          ...
                          className={classes.text}
                        >
                          {vccDepositedDetail?.booking?.customer?.ref_id ?? "-"}
                        </Typography>
                      </Grid>
                  ...
                  <Box sx={{ ml: 4 }}>
                    <Grid container spacing={1.34}>
                      ...
                      <Grid item xs={6}>
                        <Typography variant="body1" className={classes.text}>
                          {moment(vccDepositedDetail?.booking?.purchase_date).format("DD-MMM-YYYY hh:mm")}
                        </Typography>
                      </Grid>
                      <Grid item xs={5}>
                        <Typography variant="body1" className={classes.text}>
                      ...
                      <Grid item xs={6}>
                        <Typography variant="body1" className={classes.text}>
                          {vccDepositedDetail?.booking?.veh_make?.name ?? "-"}
                        </Typography>
                      </Grid>
                      <Grid item xs={5}>
                        <Typography variant="body1" className={classes.text}>
                      ...
                      <Grid item xs={6}>
                        <Typography variant="body1" className={classes.text}>
                          {vccDepositedDetail?.booking?.veh_model?.name ?? "-"}
                        </Typography>
                      </Grid>
                      <Grid item xs={5}>
                        <Typography variant="body1" className={classes.text}>
                      ...
                      <Grid item xs={6}>
                        <Typography variant="body1" className={classes.text}>
                          {vccDepositedDetail?.booking?.color ?? "-"}
                        </Typography>
                      </Grid>
                      <Grid item xs={5}>
                        <Typography variant="body1" className={classes.text}>
                      ...
                      <Grid item xs={6}>
                        <Typography variant="body1" className={classes.text}>
                          {vccDepositedDetail?.booking?.vin ?? "-"}
                        </Typography>
                      </Grid>
                      <Grid item xs={5}>
                        <Typography variant="body1" className={classes.text}>
                      ...
                      <Grid item xs={6}>
                        <Typography variant="body1" className={classes.text}>
                          {vccDepositedDetail?.booking?.lot_number ?? "-"}
                        </Typography>
                      </Grid>
                ...
                <Grid item xs={5.5}>
                  <Box sx={{ mr: 3, mt: 5 }}>
                    <Grid container spacing={0} justifyContent={"flex-end"}>
                      ...
                      <Grid item md={6} className={classes.tableCell}>
                        <Typography variant="body1" className={classes.text}>
                          GVR-{vccDepositedDetail?.booking?.id}
                        </Typography>
                      </Grid>
                      <Grid item md={6} className={classes.tableCell}>
                        <Typography variant="body1" className={classes.text}>
                      ...
                      <Grid item md={6} className={classes.tableCell}>
                        <Typography variant="body1" className={classes.text}>
                          {moment(vccDepositedDetail?.vcc?.deposit?.created_at).format("DD-MMM-YYYY hh:mm")}
                        </Typography>
                      </Grid>



                      <Box sx={{ mr: 3, mb: 8, mt: 17 }}>
                        <Grid container spacing={0} justifyContent={"flex-end"}>
                          ...
                          >
                            ...
                            >
                              <Box>AED  </Box>
                              <Box>{vccDepositedDetail?.vcc?.deposit?.amount}</Box>
                            </Typography>
                          </Grid>
                          ...
                          >
                            ...
                            >
                              <Box>$  </Box>
                              <Box>{parseFloat(parseFloat(vccDepositedDetail?.vcc?.deposit?.amount) / exchangeRate).toFixed(2)}</Box>
                            </Typography>
                          </Grid>
              ...
              <Grid container spacing={0} justifyContent={"space-between"}>
                ...
                <Grid item md={2}>
                  <Box sx={{ height: "100%", display: "flex", alignItems: "center" }}>
                    <QRCodeCanvas
                      value={window.location.origin + `/vcc-refunded-preview/${btoa("vccRefunded-" + id)}`}
                    />
                  </Box>
                </Grid>
              </Grid>
...
export default VccDepositedPreview;