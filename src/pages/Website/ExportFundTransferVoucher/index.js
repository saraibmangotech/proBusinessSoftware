...
function ExportFundTransferVoucherPreview() {
  ...
  const getFundTransferVoucherDetail = async () => {
    ...
    try {
      ...
      const { data } = await ExportFinanceServices.getFundTransferVoucherPreview(params)
  ...
  return (
    <Container>
      ...
      <PDFExport ref={contentRef} fileName="Fund Transfer Voucher">
        <Box
          sx={{
            width: "1000px",
            mx: 4,
...
export default ExportFundTransferVoucherPreview;