...
function VccRefundedPreview() {
  ...
  const getVccRefundedDetail = async () => {
    ...
    try {
      ...
      const { data } = await VccServices.getVccRefundedPreview(params)
  ...
  return (
    <Container>
      ...
      <PDFExport ref={contentRef} fileName="VCC Refunded">
        <Box
          sx={{
            width: "1000px",
            mx: 4,
...
export default VccRefundedPreview;