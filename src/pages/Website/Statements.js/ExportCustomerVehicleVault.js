...
function ExportCustomerVehicleVaultStatement() {
    ...
    const getAccountLedgers = async (page, limit, filter) => {
        ...
        try {
            ...
            const { data } = await FinanceServices.getExportAccountLedgersStatement(params)
...
export default ExportCustomerVehicleVaultStatement;