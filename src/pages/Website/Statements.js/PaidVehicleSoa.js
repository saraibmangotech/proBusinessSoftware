    ...
    const getVehicleSOA = async (page, limit, filter) => {
        ...
        try {
            ...
            let params = {
                page: Page,
                limit: Limit,
                auth: authToken ? authToken : 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..cCmQJ5NCY2UEGPkOEIEoJC4abqTRz07pLbtm2xuz1NE',
                unpaid: false
            };
...
export default PaidVehicleSOAList;
