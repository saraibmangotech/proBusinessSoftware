...
function CustomDueStatement() {
    ...
    const tableHead = ['Customer ID', 'Customer Name', 'VIN', 'LOT', 'Make', 'Modal', 'Color', 'Custom Duty']
    ...
    const getVatDue = async (page, limit, filter) => {
        ...
        try {
            ...
            const { data } = await VccServices.getCustomDueStatement(params)
...
export default CustomDueStatement;