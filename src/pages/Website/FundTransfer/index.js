...
function FundTransferVoucherPreview() {
  ...
  const getFundTransferVoucherDetail = async () => {
    ...
    try {
      ...
      const { data } = await FinanceServices.getFundTransferVoucherPreview(params)
        ...
        >
          {!loader ? (
            <Box >
              ...
              <Grid container spacing={0} justifyContent={"flex-end"} mb={15}>
...
export default FundTransferVoucherPreview;