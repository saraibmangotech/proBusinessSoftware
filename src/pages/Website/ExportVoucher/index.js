...
function ExportVoucherDetailPreview() {
	...
	const getVoucherDetails = async () => {
		...
		try {
			...
			const { data } = await ExportFinanceServices.getVoucherPreview(params)
	...
	return (
		<Container>
			...
			<PDFExport ref={contentRef} fileName="Payment Voucher">
				<Box
					sx={{
						width: "1000px",
						mx: 4,
									...
									<Box sx={{ height: "100%", display: "flex", alignItems: "center" }}>
										<QRCodeCanvas
											value={
												...
												`/export-voucher-preview/${btoa("voucher-" + id)}`
											}
										/>
									</Box>
								</Grid>
...
export default ExportVoucherDetailPreview;