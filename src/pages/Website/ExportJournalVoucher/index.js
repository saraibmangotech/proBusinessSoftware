...
function ExportJournalVoucherPreview() {
  ...
  const getJournalVoucherDetail = async () => {
    ...
    try {
      ...
      const { data } = await ExportFinanceServices.getJournalVoucherPreview(params)
  ...
  return (
    <Container>
      ...
      <PDFExport ref={contentRef} fileName="Journal Voucher">
        <Box
          sx={{
            width: "1000px",
            mx: 4,
        ...
        >
          {!loader ? (
            <Box>
              ...
              <Grid container spacing={0} justifyContent={"flex-end"} mt={5}>
                  ...
                  <Box sx={{ height: "100%", display: "flex", alignItems: "center" }}>
                    <QRCodeCanvas
                      value={
                        ...
                        `/export-journal-voucher-preview/${btoa("voucher-" + id)}`
                      }
                    />
                  </Box>
                </Grid>
...
export default ExportJournalVoucherPreview;