...
function TrialBalanceDetailed() {
    ...
    const downloadExcel = async () => {
        ...
        saveAs(blob, (toDate && fromDate) ? `Trial Balance : ${fromDate ? moment(fromDate).format('MM/DD/YYYY') : '-'} To ${toDate ? moment(toDate).format('MM/DD/YYYY') : 'Present'}` : `Trial Balance: Present `,);
    };
    ...
    const downloadExcel2 = async () => {
        ...
        saveAs(blob, (toDate && fromDate) ? `Trial Balance Detailed : ${fromDate ? moment(fromDate).format('MM/DD/YYYY') : '-'} To ${toDate ? moment(toDate).format('MM/DD/YYYY') : 'Present'}` : `Trial Balance Detailed: Present `,);
    };
