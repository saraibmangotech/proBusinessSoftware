...
function CreatePrepaidInvoices() {
    ...
    const onSubmit1 = async (formData) => {
        ...
        try {
            ...
            const promise = CustomerServices.CreateFixedAssets(obj);
    ...
    return (
        <Box m={3} sx={{ backgroundColor: "white", borderRadius: "12px" }}>
            ...
            <Box sx={{ display: "flex", justifyContent: "space-between", gap: "10px", p: 3, alignItems: "flex-end" }}>
                <Typography sx={{ fontSize: "22px", fontWeight: "bold" }}>Create Fixed Asset</Typography>
            </Box>
...
export default CreatePrepaidInvoices
