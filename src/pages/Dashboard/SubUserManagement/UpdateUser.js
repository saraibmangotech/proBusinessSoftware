...
function UpdateUser() {
  ...
  const UpdatePassword = async (formData) => {
    ...
    try {
      let obj = {
        email: getValues('email'),
        old_password: encryptData(getValues1('oldPassword')),
        new_password: encryptData(getValues1('newPassword')),

      }


      console.log(obj);
      const promise = UserServices.UpdatePassword(obj);
  ...
  return (
    <Box sx={{ p: 3, borderRadius: 3, }}>
      ...
      <Box component="form" onSubmit={handleSubmit(UpdateUser)} >
        ...
        <Grid container spacing={0} mt={5} p={1} gap={3} >
        ...
        <Grid container spacing={0} mt={5} p={1} gap={3}>
          <Grid item xs={12} sm={5}>
            <InputField
              ...
              error={errors1?.oldPassword?.message}
              register={register1("oldPassword", {
          ...
          <Grid item xs={12} sm={5}>
            <InputField
              ...
              error={errors1?.newPassword?.message}
              register={register1("newPassword", {
          ...
          <Grid item xs={12} sm={5}>
            <InputField
              ...
              register={register1("confirmPassword", {
                ...
                validate: value =>
                  value === getValues1('newPassword') || 'Passwords do not match.',
              })}
            />
          </Grid>
        </Grid>
