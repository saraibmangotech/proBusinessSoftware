    ...
    const submitForm1 = async (formData) => {
        ...
        try {
            let obj = {
                ...
                account_id: selectedMode?.id == 'Cash' ? 700117 : null, // By default 700117 for Cash
                ref_id:  selectedMode?.id == 'Bank' || selectedMode?.id == 'Bank' ?  "2" : null, //bank or card id null for cash
            ...
            <Box m={3} sx={{ backgroundColor: "white", borderRadius: "12px" }}>
                {
                    <>
                        <Box component={"form"} onSubmit={handleSubmit1(submitForm1)}>
                            ...
                            {payButton && <Grid container mt={2} spacing={2}>
                                ...
                                <Grid item md={3} sm={12} xs={12}>
                                    <SelectField
                                        ...
                                        options={[{ id: 'Cash', name: 'Cash' }, { id: 'Bank', name: 'Bank' }, { id: 'Card', name: 'Card' }]}
                                ...
                                {selectedMode?.id == 'Bank' && <Grid item md={3} sm={12} xs={12}>
                                    <SelectField
                                        label="Banks"
                                        size="small"
