...
function UpdateReceiptVoucher() {
    ...
    const UpdateReceiptVoucher = async (formData) => {
  ...
  const addItem = (description, amount) => {
    ...
    return (
        <Box sx={{ p: 3, borderRadius: 3 }} component={'form'} onSubmit={handleSubmit1(UpdateReceiptVoucher)}>
                                ...
                                <TableCell><Box sx={{ display: 'flex', gap: 1 }}>
                                    ...
                                    <Box>
                                        ...
                                        {true && <Box sx={{ cursor: 'pointer' }} component={'img'} src={Images.deleteIcon} onClick={() => {
                                            ...
                                            setRows(rows?.filter((_, index2) => index2 !== index));

                                            let filteredData = rows?.filter((_, index2) => index2 !== index);
