...
function CustomerVehicleLedger() {
  ...
  const handleFilter = (search) => {
    let data = {
      ...
      account_id: selectedCustomer?.accounts.find(
        (account) =>
          account.type_code === "A2" &&
          account?.currency == "usd" &&
          account.primary_series === 20002
      ).id,
  ...
  return (
    <Box sx={{ m: 4, mb: 2 }}>
      ...
      >
        ...
        >
          {state?.accountName} Customer Vehicle Ledger
        </Typography>
      ...
      {accountLedgers && (
        <Fragment>
          <PDFExport ref={contentRef} landscape={true} paperSize="A4" margin={5}
            fileName="Customer Vehicle Ledger"
          >
                        ...
                        {accountLedgers.map((item, index) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <Cell className="pdf-table">
                                ...
                                >
                                  {item.entry?.reference_no?.length > 20
                                    ? item.entry?.reference_no?.slice(0, 20) +
                                    "..."
                                    : item.entry?.reference_no}{" "}
                                </Tooltip>
                                <Box
                              ...
                              <Cell className="pdf-table">{CommaSeparator(item?.debit_cur)}</Cell>
                              <Cell className="pdf-table">{CommaSeparator(item?.credit_cur)}</Cell>
