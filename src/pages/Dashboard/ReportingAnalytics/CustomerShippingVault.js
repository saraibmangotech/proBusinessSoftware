...
function CustomerShippingVault() {
    ...
    const handleFilter = () => {
        let data = {
            ...
            account_id: selectedCustomer?.accounts.find(account => account.type_code === 'L2' && account.primary_series === 50005).id,
            ...
            {accountLedgers &&
                <Fragment>
                    <PDFExport ref={contentRef} landscape={true} paperSize="A4" margin={5}
                        fileName="Customer Shipping Vault"
                    >
...
export default CustomerShippingVault;