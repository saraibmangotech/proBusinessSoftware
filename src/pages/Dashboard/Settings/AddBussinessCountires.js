...
function AddBusinessCountries() {
  ...
  // *For Create Buyer ID
  const createBusinessLocation = async (formData) => {
    setLoading(true);
    ...
    try {
      ...
      console.log(obj, "obj");
      const { message } = await BuyerServices.createBusinessLocation(obj);
  ...
  return (
    ...
    >
      <Box component="form" onSubmit={handleSubmit(createBusinessLocation)}>
        <Grid container spacing={2} alignItem={"center"}>
          ...
          <Grid container spacing={1} item xs={12} sm={12}>
            ...
            <Grid item xs={12} sm={12} sx={{ mt: 2, textAlign: "right" }}>
              <PrimaryButton title="Add" type="submit" loading={loading} />
            </Grid>
          </Grid>
        </Grid>
      </Box>
...
export default AddBusinessCountries;
