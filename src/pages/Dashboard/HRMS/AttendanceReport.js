            ...
            <Tooltip title={`Duration: ${duration}`} arrow>
              <Chip
                ...
                sx={{
                  ...
                  py: 4,
                  px: 2,
                  backgroundColor: status === "Present" ? "#daffd3" : status === "A" ? "#fee6e4" : "#e6f2ff",
...
export default function AttendanceTable() {
  ...
  const downloadExcel = async () => {
    ...
    const fileName = `Attendance Report - ${startDate ? new Date(startDate).toLocaleDateString("en-GB") : "Start"} to ${
