...
function MonthlyInvoice() {
  ...
  const tableHead = [
    ...
    { name: "Service Charges", key: "visa_rate" },
    { name: "Tax", key: "tax" },
    ...
    <Box sx={{ p: 3 }}>
          ...
          <Grid item xs={4}>
            ...
            <Box sx={{ mt: 1 }}>
              ...
              <Typography sx={{ fontSize: "12px" }} variant="body1">
                ...
                {moment(invoiceDetail?.created_at).format('MM-DD-YYYY')}
              </Typography>
                            ...
                            return (
                              ...
                              >
                                ...
                                <Cell
                                  ...
                                  className="pdf-table"
                                >
                                  {parseFloat(parseFloat(item?.total_amount)*0.05).toFixed(2)}
                                </Cell>
                                <Cell
                                  style={{ textAlign: "left" }}
                                  className="pdf-table"
                                >
                                  {parseFloat(parseFloat(parseFloat(item?.total_amount)*0.05) + parseFloat(item?.total_amount)).toFixed(2)}
                                </Cell>
                              </Row>
                            );
                          })}
      ...
      <Grid item xs={12} sm={6} sx={{mt:-3}}>
        <Grid container>
          ...
          <Grid item xs={6}>
            <Typography sx={{fontSize:"12px"}} variant="body1" align="right">{invoiceDetail?.total_amount}AED</Typography>
          </Grid>
          <Grid item xs={6}>
            <Typography sx={{fontSize:"12px",textAlign:"right"}} variant="body1">Tax</Typography>
          </Grid>
          <Grid item xs={6}>
            <Typography sx={{fontSize:"12px"}} variant="body1" align="right">{invoiceDetail?.tax} AED</Typography>
          </Grid>
          {/* <Grid item xs={6}>
          ...
          <Grid item xs={6}>
            <Typography sx={{fontSize:"12px" ,color:Colors.primary}} variant="h6" align="right" ><strong>{parseFloat(parseFloat(invoiceDetail?.total_amount)+parseFloat(invoiceDetail?.tax)).toFixed(2)} AED</strong></Typography>
          </Grid>
        </Grid>
      </Grid>
    </Grid>
