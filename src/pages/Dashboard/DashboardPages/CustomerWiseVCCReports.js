...
function CustomerWiseVCCReports() {
  ...
  let iframeUrl = METABASE_SITE_URL + "/embed/dashboard/" + localStorage.getItem('vccToken') + "#bordered=false&titled=true";
...
export default CustomerWiseVCCReports;