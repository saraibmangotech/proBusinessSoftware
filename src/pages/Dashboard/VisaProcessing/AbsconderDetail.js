    ...
    return (
        <Box sx={{ p: 3 }}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', gap: '10px', alignItems: 'flex-end' }}>
                <Typography sx={{ fontSize: "22px", fontWeight: 'bold' }} >ABSCONDER DETAIL</Typography>
                    ...
                    <Grid item xs={6} >
                        ...
                        <Grid item xs={12} sm={6}>
                            <Box mb={2} mt={2}>
                                ...
                                <Typography mb={2} mt={2} variant="body1">Nationality : <span style={{ color: "#0F2772" }}>{detail?.candidate?.name}</span></Typography>
...
export default AbsconderDetail;
