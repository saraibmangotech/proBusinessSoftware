...
function UpdateEOSList() {
    ...
    const columnConfig = [
        ...
        { key: "workingDays", header: "Working Days", type: "manual" },
        ...
        { key: "leaves_encashment", header: "Leaves Encash", type: "manual" },
    ...
    const UpdateEOS = async (formData) => {
        try {
            ...
            const promise = UserServices.UpdateEOS(obj)
    ...
    return (
        <Box sx={{ p: 3 }}>
            <Box sx={{ display: "flex", justifyContent: "space-between", mb: 2, alignItems: "center" }}>
                <Typography sx={{ fontSize: "24px", fontWeight: "bold" }}>Update Final Statement</Typography>
            </Box>
            ...
            <Box sx={{ display: "flex", gap: "10px", justifyContent: "flex-end" }}>
                <PrimaryButton bgcolor={"#001f3f"} title="Update" onClick={() => UpdateEOS()} disabled={data?.length == 0} />
            </Box>
        </Box>
    )
}

export default UpdateEOSList
