...
function VatOutputRegister() {
    ...
    const handleExcelDownload = () => {
        ...
        const worksheet = workbook.addWorksheet("VAT Output Register")
        ...
        const titleRow = worksheet.addRow(["VAT OUTPUT REGISTER"])
        ...
        // Add custom total rows from data object (if provided)
        ...
        const download = async () => {
            ...
            saveAs(blob,
                toDate && fromDate
                    ? `vat_output_register : ${fromDate ? new Date(fromDate).toLocaleDateString('en-GB', {day: '2-digit', month: '2-digit', year: 'numeric'}) : "-"} To ${toDate ? new Date(toDate).toLocaleDateString('en-GB', {day: '2-digit', month: '2-digit', year: 'numeric'}) : "Present"}`
...
export default VatOutputRegister;