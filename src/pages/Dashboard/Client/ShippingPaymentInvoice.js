...
function ShippingPaymentInvoice() {
    const { id } = useParams();
    ...
    const getTTDetail = async () => {
        ...
        try {
            ...
            const { data } = await ClientServices.getShippingInvoice(params);
            setTtDetail(data?.details?.details);
    ...
    return (
        <Container>
            ...
            <PDFExport ref={contentRef}
                fileName="Shipping Payment Received Detail"
            >
                <Box
                    sx={{
                        width: "1000px",
                        ...
                        <Box sx={{ p: 5 }} >
                            <Grid container spacing={2} alignItems="flex-start">
                                <Grid item xs={12} sm={12}>
                                    ...
                                    >
                                        Shipping Payment Received Detail
                                    </Typography>
                                </Grid>
                                <Grid
                                    container
                                                ...
                                                {ttDetail && ttDetail.map((item, index) => (
                                                    <Row >
                                                        ...
                                                        <Cell >
                                                            ...
                                                            <Typography variant="body1">
                                                                {
                                                                    item?.costing?.booking?.buyer?.name ?? "-"
                                                                }
                                                            </Typography>
                                                        ...
                                                        <Cell sx={{ width: "180px" }} >
                                                            {parseFloat(item?.applied_amount).toFixed(2)}
                                                        </Cell>
                                ...
                                <Grid container item xs={12} sm={12} justifyContent={"space-between"}>
                                    ...
                                    <Grid item sm={4}>
                                        ...
                                        >
                                            ...
                                            <Typography variant="body1">
                                                {parseFloat(otherDetails?.cash_amount).toFixed(2)}
                                            </Typography>
                                        </Box>
                                        <Box
                                            sx={{
                                        ...
                                        >
                                            ...
                                            <Typography variant="body1">
                                                {parseFloat(otherDetails?.vault_amount).toFixed(2)}
                                            </Typography>
                                        </Box>
                                    </Grid>
                                </Grid>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <Typography variant="body1" sx={{ textAlign: "right" }}>
                                            {parseFloat(otherDetails?.total).toFixed(2)}
                                        </Typography>
                                    </Box>
                                </Grid> */}
                                </Grid>
                                    ...
                                    >
                                        <QRCodeCanvas
                                            value={
                                                ...
                                                `/shipping-detail-preview/${btoa("shipping-" + id)}`
                                            }
                                        />
                                    </Box>
                                </Grid>
...
export default ShippingPaymentInvoice;
