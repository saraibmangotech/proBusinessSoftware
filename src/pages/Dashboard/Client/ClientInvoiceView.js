...
function ExportInvoice() {
	...
	const getClientInvoice = async () => {
		...
		try {
			...
			const { data } = await ClientServices.getClientInvoice(params);
	...
	return (
		<Container>
			...
			<PDFExport ref={contentRef}
				fileName="Import Shipping Invoice"
			>
				<Box
					sx={{
						width: "1000px",
								...
								<Grid item md={5.5}>
									...
									<Box sx={{ mr: 2, mb: 8, ml: 2 }}>
										<Grid container spacing={0} justifyContent={"flex-end"}>
											<Grid item md={4}></Grid>
											<Grid item md={8}></Grid>
											{invoiceDetail?.payments.length > 0 && <> <Grid item md={4}>
												<Typography
													variant="subtitle2"
								...
								<Grid item md={5.5}>
									...
									<Box sx={{ mr: 3, mb: 8 }}>
										<Grid container spacing={0} justifyContent={"flex-end"}>
											...
											<Grid item md={3} className={classes.tableCell}>
												<Typography
													variant="body1"
													className={classes.text}
													sx={{ textAlign: "right" }}
											...
											<Grid item md={3} className={classes.tableCell} sx={{ fontWeight: 'bold !important' }}>
												<Typography
													variant="body1"
													className={classes.text}
													sx={{ textAlign: "right" }}
											...
											<Grid item md={3} className={classes.tableCell}>
												...
												>
													{invoiceDetail?.costing
														? parseFloat(invoiceDetail?.costing?.vat).toFixed(2)
														: "00"}
												</Typography>
											</Grid>
											<Grid item md={3} className={classes.tableCell}>
												...
												>
													{invoiceDetail?.costing
														? parseFloat(parseFloat(invoiceDetail?.costing?.vat * currencyExchangeRate).toFixed(2)).toFixed(2)
														: "00"}
												</Typography>
											</Grid>
											<Grid item md={6} className={classes.tableCell}>
											...
											<Grid item md={3} className={classes.tableCell}>
												...
												>
													{invoiceDetail?.costing
														? parseFloat(parseFloat(invoiceDetail?.costing?.vat) + parseFloat(invoiceDetail?.costing?.custom_duty)).toFixed(2)
														: "00"}
												</Typography>
											</Grid>
											<Grid item md={3} className={classes.tableCell}>
												...
												>
													{invoiceDetail?.costing
														? parseFloat(parseFloat((invoiceDetail?.costing?.vat) + parseFloat(invoiceDetail?.costing?.custom_duty)) * currencyExchangeRate).toFixed(2)
														: "00"}
												</Typography>
											</Grid>
											<Grid item md={6} className={classes.tableCell}>
											...
											<Grid item md={3} className={classes.tableCell}>
												...
												>
													{invoiceDetail?.costing
														? parseFloat(parseFloat(sum) + parseFloat(parseFloat(invoiceDetail?.costing?.vat) + parseFloat(invoiceDetail?.costing?.custom_duty))).toFixed(2)
														: "00"}
												</Typography>
											</Grid>
											<Grid item md={3} className={classes.tableCell}>
												...
												>
													{invoiceDetail?.costing
														? parseFloat(parseFloat((sum) + parseFloat(parseFloat(invoiceDetail?.costing?.vat) + parseFloat(invoiceDetail?.costing?.custom_duty))) * currencyExchangeRate).toFixed(2)
														: "00"}
												</Typography>
											</Grid>
											<Grid item md={6} className={classes.tableCell}>
											...
											<Grid item md={3} className={classes.tableCell}>
												...
												>
													{invoiceDetail?.costing
														? parseFloat(invoiceDetail?.costing?.discount).toFixed(2)
														: "00"}
												</Typography>
											</Grid>
											<Grid item md={3} className={classes.tableCell}>
												...
												>
													{invoiceDetail?.costing
														? parseFloat(parseFloat(invoiceDetail?.costing?.discount) * currencyExchangeRate).toFixed(2)
														: "00"}
												</Typography>
											</Grid>
											<Grid item md={6} className={classes.tableCell}>
											...
											<Grid item md={3} className={classes.tableCell}>
												...
												>
													{invoiceDetail?.costing
														? parseFloat(parseFloat(sum) + parseFloat(parseFloat(invoiceDetail?.costing?.vat) + parseFloat(invoiceDetail?.costing?.custom_duty)) - parseFloat(invoiceDetail?.costing?.discount)).toFixed(2)
														: "00"}
												</Typography>
											</Grid>
											<Grid item md={3} className={classes.tableCell}>
												...
												>
													{invoiceDetail?.costing
														? parseFloat(parseFloat((sum) + parseFloat(parseFloat(invoiceDetail?.costing?.vat) + parseFloat(invoiceDetail?.costing?.custom_duty)) - parseFloat(invoiceDetail?.costing?.discount)) * currencyExchangeRate).toFixed(2)
														: "00"}
												</Typography>
											</Grid>
											<Grid item md={6} className={classes.tableCell}>
