...
function UpdateCustomerPayment() {
    ...
    const getCustomerPaymentDetail = async () => {
        ...
        try {
            ...
            setPaidAt(new Date(payment?.date))
        ...
        if (existingTotal == getValues1('total')) {
            ...
            try {
                ...
                if (detail?.is_paid == true) {
                    ...
                    const promise = CustomerServices.customerPaymentUpdate(obj)
            ...
            <Box m={3} sx={{ backgroundColor: "white", borderRadius: "12px" }}>
                {
                    <>
                        <Box component={"form"} onSubmit={handleSubmit1(submitForm1)}>
                            ...
                            >
                                <Typography sx={{ fontSize: "22px", fontWeight: "bold" }}>Update Customer Payment</Typography>
                            </Box>
