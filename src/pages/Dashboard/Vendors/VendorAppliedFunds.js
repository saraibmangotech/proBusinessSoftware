...
function VendorAppliedFunds() {
  ...
  const getVendorAppliedFunds = async (page, limit, filter) => {
    ...
    try {
      ...
      const { data } = await VendorServices.getVendorAppliedFunds(params)
...
export default VendorAppliedFunds;
