...
function ExportContainerInvoice() {
	...
	const getExportInvoice = async () => {
		...
		try {
			...
			const { data } = await ExportServices.getExportContainerDetails(params);
			setInvoiceDetail(data?.container);
						...
						<Box >
							...
							<Grid container spacing={0} justifyContent={"space-between"}>
								...
								<Grid item md={5.5}>
									...
									<Box
										className={classes.headingBg}
										sx={{ bgcolor: Colors.primary, marginTop: "17% !important" }}
									>
										<Typography variant="h4" className={classes.heading}>
										...
										<Grid container spacing={0} justifyContent={"flex-end"}>
											...
											<Grid item md={4} className={classes.tableCell}>
												<Typography
													...
													sx={{ textAlign: "right" }}
												>
													{parseFloat(invoiceDetail?.paid_amount).toFixed(2)
											...
											<Grid item md={4} className={classes.tableCell}>
												<Typography
													...
													sx={{ textAlign: "right" }}
												>
													{parseFloat(parseFloat(invoiceDetail?.price) - parseFloat(invoiceDetail?.paid_amount)).toFixed(2)
											...
											<Grid item md={4} className={classes.tableCell}>
												<Typography
													...
													sx={{ textAlign: "right" }}
												>
													{parseFloat(parseFloat(parseFloat(invoiceDetail?.price) - parseFloat(invoiceDetail?.paid_amount)) * currencyExchangeRate).toFixed(2)
														?? "00"}
												</Typography>
											</Grid>
										</Grid>
									...
									<Box sx={{ height: "100%", display: "flex", alignItems: "center" }}>
										<QRCodeCanvas
											value={
												...
												`/export-container-preview/${btoa("containerinvoice-" + id)}`
											}
										/>
									</Box>
								</Grid>
...
export default ExportContainerInvoice;
