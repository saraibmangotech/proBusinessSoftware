...
function ExportContainerPaymentReceipt() {
    ...
    const getPaymentDetails = async () => {
        ...
        try {
            ...
            const { data } = await ExportServices.getExportContainerPaymentDetails(params)
                                                    ...
                                                    <Fragment key={index}>
                                                        ...
                                                        <Grid item md={2} className={classes.tableCell}>
                                                            <Typography
                                                                ...
                                                                className={classes.text}
                                                            >
                                                                {paymentReceiptDetail?.details[0]?.container?.container_number}
                                                            </Typography>
                                                        </Grid>
                                                        <Grid item md={2} className={classes.tableCell}>
                                                            <Typography
...
export default ExportContainerPaymentReceipt;