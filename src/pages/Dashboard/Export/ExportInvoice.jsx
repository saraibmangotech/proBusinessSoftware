										...
										<Grid container spacing={0} justifyContent={"flex-end"}>
											...
											<Grid item md={4} className={classes.tableCell}>
												<Typography
													...
													sx={{ textAlign: "right" }}
												>
													{parseFloat(invoiceDetail?.final_price) - parseFloat(invoiceDetail?.vendor_paid)
											...
											<Grid item md={4} className={classes.tableCell}>
												<Typography
													...
													sx={{ textAlign: "right" }}
												>
													{parseFloat(parseFloat(parseFloat(invoiceDetail?.final_price) - parseFloat(invoiceDetail?.vendor_paid)) * currencyExchangeRate).toFixed(2)
														?? "00"}
												</Typography>
											</Grid>
										</Grid>
