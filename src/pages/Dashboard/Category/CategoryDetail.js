...
function CategoryDetail() {
    ...
    const submitForm1 = async (formData) => {
        ...
        try {
            ...
            const promise = CustomerServices.UpdateProductCategory(obj);
    ...
    const getData = async () => {
        try {
            ...
            const { data } = await CustomerServices.getProductCategoryDetail(params);
             ...
             {<>
                     ...
                     <Box component={'form'} onSubmit={handleSubmit1(submitForm1)}>
                       <Box sx={{ display: 'flex', justifyContent: 'space-between', gap: '10px', p: 3, alignItems: 'flex-end' }}>
                         <Typography sx={{ fontSize: "22px", fontWeight: 'bold' }} > Category Detail</Typography>
