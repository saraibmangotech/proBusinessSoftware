...
function ReceiptDetail() {
    ...
    const getReceiptDetail = async () => {
        ...
        try {
            ...
            const { data } = await FinanceServices.getReceiptDetail(params)
                                        ...
                                        <Grid container spacing={0.5}>
                                            ...
                                            <Grid item xs={6} sm={6} md={6}>
                                                <Typography
                                                    ...
                                                    className={classes.text}
                                                >
                                                    {receiptDetail?.cashier_usd_account ? receiptDetail?.cashier_usd?.name : receiptDetail?.cashier_aed_account ? receiptDetail?.cashier_aed_account?.name : receiptDetail?.bank?.name}
                                                </Typography>
                                            </Grid>
                                            <Grid item xs={5} sm={5} md={5}>
                                                <Typography variant="body1" className={classes.text}>
                                            ...
                                            <Grid item xs={6} sm={6} md={6}>
                                                <Typography
                                                    ...
                                                    className={classes.text}
                                                >
                                                    {receiptDetail?.cashier_usd_account ? receiptDetail?.cashier_usd_account : receiptDetail?.cashier_aed_account ? receiptDetail?.cashier_aed_account : receiptDetail?.bank_account_id}
                                                </Typography>
                                            </Grid>
